...
public class HuntAndKillMazeAlgorithm : MazeAlgorithm {
	...
	private bool courseComplete = false; //after any hunt phase (HundAndKill), if it cannot find any empty or any non-visited cells, then that get set to true.
	...
	private void HuntAndKill() {
		mazeCells [currentRow, currentColumn].visited = true; //where are we? in 0,0
